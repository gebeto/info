            ...
            var t = "undefined" != typeof window ? window : self,
              ...
              f = function(e, f, p, h, m) {
                ...
                var v,
                  ...
                  j = n(function(n) {
                    return (
                      ...
                      (n.send = function() {
                        if (!q) {
                          if (s == u) return void c.push(n);
                          if (M) return void (c.length && c.shift().send());
                          if (
                            (++s,
                            (q = !0),
                            (w = d()),
                            ...
                            L
                              ? w.open(e, f)
                              : (w.open(e, f, h.async, h.user, h.password),
                                l &&
                                  h.async &&
                          ...
                          l || L
                            ...
                            h.async
                              ? "timeout" in w
                                ? ((w.timeout = h.timeout), (w.ontimeout = R))
                                : (b = setTimeout(R, h.timeout))
                              : L && (w.ontimeout = function() {}),
                            "auto" != h.responseType &&
                              "overrideMimeType" in w &&
                              w.overrideMimeType(k[h.responseType]),
                            m && m(w),
                            L
                              ? setTimeout(function() {
                                  w.send("GET" != e ? p : null);
                        ...
                        if (E) {
                          ...
                          switch (e) {
                            ...
                            case "xml":
                              try {
                                t.DOMParser
                                  ? (_ = new DOMParser().parseFromString(
                                      w.responseText,
                                      "text/xml"
                                    ))
                                  : ((_ = new ActiveXObject(
                              ...
                              if (
                                !_ ||
                                !_.documentElement ||
                                _.getElementsByTagName("parsererror").length
                              )
                                throw "Invalid XML";
                              break;
                            default:
                  ...
                  R = function() {
                    M ||
                      (h.attempts && ++x == h.attempts
                        ? O("Timeout (" + f + ")")
                        : (w.abort(), (q = !1), j.send()));
                  };
                if (
                  ((h.async = !("async" in h && !h.async)),
                  (h.cache = "cache" in h && !!h.cache),
                  (h.dataType = "dataType" in h ? h.dataType.toLowerCase() : i),
                  (h.responseType =
                    "responseType" in h
                      ? h.responseType.toLowerCase()
                      : "auto"),
                  (h.user = h.user || ""),
                  ...
                  "ArrayBuffer" in t && p instanceof ArrayBuffer
                    ? (h.dataType = "arraybuffer")
                    : "Blob" in t && p instanceof Blob
                    ? (h.dataType = "blob")
                    : "Document" in t && p instanceof Document
                    ? (h.dataType = "document")
                    : "FormData" in t &&
                ...
                return (
                  "Content-Type" in P ||
                    ...
                    (h.dataType in k &&
                      k[h.dataType] &&
                      (P["Content-Type"] = k[h.dataType])),
                  P.Accept ||
                    (P.Accept =
                      h.responseType in S ? S[h.responseType] : "*/*"),
                  v ||
              ...
              p = function(e) {
                ...
                return n(function(n) {
                  ...
                  for (var u in e) u in n || (n[u] = e[u]);
                  return (
                    (n.send = function() {
                      for (var e = 0, a = t.length; a > e; ++e) t[e].send();
                      return n;
                    }),
                    (n.abort = function() {
                      for (var e = 0, a = t.length; a > e; ++e) t[e].abort();
                      return n;
                    }),
                    n
                  );
              ...
              h = {
                ...
                setDefaultXdrResponseType: function(e) {
                  return (r = e.toLowerCase()), h;
                },
                setDefaultDataType: function(e) {
                  return (i = e.toLowerCase()), h;
                },
...
try {
  ...
  if ((ce.preventDefault(), ce.defaultPrevented !== !0))
...
!(function(e) {
  ...
  (function(e) {
        ...
        var t = e.URL,
          n = function(t, n) {
            ...
            if (n && (void 0 === e.location || n !== e.location.href)) {
              ...
              try {
                if (0 !== a.href.indexOf(n)) throw new Error(a.href);
              } catch (r) {
            ...
            if (
              ((i.href = t),
              a && (o.body.appendChild(i), (i.href = i.href)),
    ...
    if ((t() || n(), void 0 !== e.location && !("origin" in e.location))) {
      ...
      try {
        Object.defineProperty(e.location, "origin", { get: a, enumerable: !0 });
      } catch (o) {
  ...
  (function(e) {
    ...
    function n(t) {
      t.forEach(function(t) {
        var n = document.querySelector(
          '[data-announcement-item-id="' + t.id + '"]'
        );
    ...
    function a(t, n) {
      var a,
        r = document.querySelector(".announcement-content"),
        i = e.announcementManager.data;
      t.forEach(function(t, u) {
        ...
        s
          ? ((a = i.filter(function(e) {
            ...
            a.text[e.announcementManager.locale] !== t.text[n] &&
              e.util.fade(s, "out", 500, function() {
                (s.innerHTML = t.text[n]), e.util.fade(s, "in", 500);
              }))
          : ((s = o(t, n)),
            (s =
              0 === u
                ...
                : r
                    .querySelector(".announcement-item:nth-child(" + u + ")")
    ...
    function o(e, t) {
      return [
        '<div class="announcement-item" data-announcement-item-id="',
        e.id,
        '">',
        e.text[t],
        "</div>"
    ...
    e.announcementManager = { data: [], locale: "", renderAnnouncements: r };
  })(window.PL),
  (function(e) {
    function t(e, t) {
      -1 !== t.indexOf(s) &&
        ((e.innerHTML = t.replace(s, "<countdown></countdown>")),
  ...
  (function(e) {
    function t(e) {
      ...
      n.searchParams.forEach(function(e, n) {
        ...
        a.has("pld") &&
          !t.searchParams.has("pld") &&
          t.searchParams.set("pld", a.get("pld")),
        (document.location.href = t.toString());
    }
    e.foManager = { loadRedirectURL: t };
  })(window.PL),
  (function(e) {
    function t(e, t) {
      _gaq.push([
        "paylogic._trackTiming",
        "Permanent Queue",
        "AJAX update",
        e,
        t,
    ...
    var o = [];
    (e.gaManager = { sendGAPage: n, sendGATiming: t }),
      e.analytics.paylogic_tracker_id &&
        (o.push("paylogic"),
        _gaq.push(["paylogic._setAccount", e.analytics.paylogic_tracker_id])),
      e.analytics.event_tracker_id &&
        (o.push("event"),
  ...
  (function(e) {
    function t() {
      n(o.value), document.dispatchEvent(new CustomEvent("lang-changed"));
    }
    function n(t) {
      (e.langManager.locale = t), o && o.value !== t && (o.value = t);
    }
    function a(t, n) {
      return (
        "number" == typeof n && 1 !== n && (t += "s"),
        e.translations[e.langManager.locale][t]
      );
    }
    var o = document.querySelector("#lang");
    o && o.addEventListener("change", t),
      (e.langManager = { locale: null, setLocale: n, translate: a });
  })(window.PL),
  (function(e) {
    function t(t, n) {
      var a = n[t];
    ...
    function a() {
      ...
      n(e.queueData.start_date) &&
        ((s = a.active_page_name), (c = t("active_page", a))),
        (s !== r || o !== i) &&
          (e.util.fade(u, "out", r ? 500 : 0, function() {
            var t = { detail: { element: u, pageHtml: c, pageName: s } };
            (u.innerHTML = c),
    ...
    function o() {
      (r = "loading"),
        (u.innerHTML = '<h2 class="loading">Loadingâ€¦</h2>'),
        e.util.fade(u, "in", 500);
    }
    var r = null,
      i = null,
      u = document.querySelector(".template-content");
    e.pageManager = { renderPage: a, loadingMessage: o };
  })(window.PL),
  (function(e) {
    function t(e) {
      var t =
    ...
    function i() {
      var e,
        t = {},
        n = {},
        a = document.querySelector(".bg-media"),
        o = document.querySelector(".bg-media iframe");
    ...
    var u,
      s = t(e.media.youtube_url),
      c = Boolean(navigator.userAgent.match("Chrome/"));
    s &&
      !e.isMobileBrowser &&
  ...
  (function(e) {
    function t() {
      ...
      if (
        e.media.images &&
        0 !== e.media.images.length &&
        (!e.media.youtube_url || e.isMobileBrowser)
      ) {
    ...
    function a() {
      ...
      return (
        ...
        1 === e.media.images.length
          ? void clearInterval(o)
          : (r++, void (r === e.media.images.length && (r = 0)))
      );
    }
    var o,
      r = 0,
  ...
  (function(e) {
    function t(e) {
      ...
      return (
        (t.src = "https://open.spotify.com/embed?uri=" + encodeURIComponent(e)),
    ...
    var n, a;
    (a && a === e.media.spotify_embed) ||
      ((a = e.media.spotify_embed),
      n && document.body.removeChild(n),
      a &&
        ((n = t(a)), document.querySelector(".pl-body-footer").appendChild(n)));
  })(window.PL),
  (function(e) {
    e.translations = {
      nl: {
  ...
  (function(e) {
    ...
    function a(e) {
      ...
      clearTimeout(p),
        e &&
          ((t = new Date(e).getTime() - new Date().getTime()),
        ...
        : ((e.queueData = t),
          t.redirect
            ? (o(""),
              ...
              e.foManager.loadRedirectURL(t.redirect))
            : (o(t.token || ""),
              a(t.start_date),
              e.gaManager.sendGATiming(n, "success"),
              null === e.langManager.locale &&
                e.langManager.setLocale(t.content.locale),
              c(),
              s(
                t.refresh_seconds
    ...
    function t(e, t, n, a) {
      function o() {
        (i = r ? i + s : i - s),
          ...
          (0 >= i || i >= 1) && (clearInterval(c), a && a.call(this));
      }
      var r = "in" === t,
        i = r ? 0 : 1,
        u = 16,
        s = u / n;
      r && ((e.style.display = "block"), (e.style.opacity = i));
